...
description: "Образовательная платформа для изучения сетевой инфраструктуры Dark Web: Tor, SOCKS5, I2P, Onion-сервисы и ИИ-ассистент"
...
Обучающая платформа для освоения сетевой инфраструктуры анонимных сетей. Все материалы на русском языке: теория, конфигураторы, визуализации и ИИ-ассистент.
...
👉 [Открыть платформу DARK]({{ page.demo }}){: .project-link}
