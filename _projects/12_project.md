...
description: "Углублённая лаборатория по Web Cache Deception: 9 модулей, ИИ-наставники, песочницы, геймификация"
...
Углублённая лаборатория для изучения уязвимости Web Cache Deception (WCD) по материалам PortSwigger Web Security Academy. 9 специализированных модулей с ИИ-наставниками, интерактивными песочницами и системой геймификации — всё на русском языке.

### Что представляет собой платформа

Ресурс превращает все лаборатории PortSwigger по Web Cache Deception в структурированный обучающий опыт. Отдельная страница с теорией, практическими примерами и персональным ИИ-наставником — ассистент отвечает на вопросы по нажатию на иконку чата. Встроенная система геймификации мотивирует прохождение: XP, уровни, ачивки, серии дней и ежедневные задания.
...
Модули оснащены специализированными чат-ботами с уникальной личностью и экспертными знаниями. Ассистент не открывается автоматически — достаточно нажать иконку чата, когда возникнет вопрос:
...
Все наставники отвечают на русском языке, приводят примеры HTTP-запросов и заголовков, пошагово разбирают сложные концепции и предлагают типовые вопросы для быстрого старта.

### Песочницы

В модули встроены интерактивные песочницы для практики:
...
- **XP и уровни** — за пройденные разделы начисляется опыт
...
Встроенная панель тестирования доступности ИИ-моделей через OpenRouter API: проверка rate limits, задержки и статуса в реальном времени. Пользователь может добавить свой OpenRouter API-ключ для использования свободных моделей.
